            ...
            <div className="flex justify-between max-md:flex-col-reverse md:grid md:grid-cols-2 max-md:gap-10 gap-4 m-10 w-full h-full">
                ...
                <div className="flex items-center justify-center max-md:bg-background max-md:rounded-lg max-md:p-2 max-md:shadow-lg z-50 max-md:w-fit">
                    <div className="flex justify-between gap-7 items-end md:items-center ">
                        <div className="">
                            <Link href="/" className="underline-animation text-foreground md:text-background text-3xl font-medium text-nowrap">A propos</Link>
                        </div>
                        <div className="">
                            <Link href="/contact" className="underline-animation text-foreground md:text-background text-3xl font-medium text-nowrap">Contact</Link>
                        </div>
                        <div className="">
                            <Link href="https://github.com/Lirobi" target="_blank" className="underline-animation text-foreground md:text-background text-3xl font-medium text-nowrap">Github</Link>
                        </div>
                    </div>
                </div>
            </div>
