...
export default function ProjectCard({ title, description, imageUrl, projectUrl, tags, appUrl }: ProjectCardProps) {
    return (
        <div className="flex flex-col justify-between bg-white rounded-lg shadow-lg overflow-hidden transition-transform duration-300 hover:scale-105 h-full w-full max-w-[320px]">
            <div>
